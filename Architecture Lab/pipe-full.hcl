...
# I didn't modify the pipe processor, as I did not need to use any operation requiring it in to_binary_string.ys. I used subq and then jxx for branching.
# I focused solely on optimizing to_binary_string.ys.
